...
<main id="siteMain" role="main" class="page-builder-body">
  ...
  <section class="blog-index archive-body is-top--na is-bottom--md">
    ...
    <?php echo do_shortcode('[ajax_load_more id="8687150447"  category="'. $category->slug .'" loading_style="light-grey" container_type="div" css_classes="blog-listing" post_type="post" posts_per_page="9" images_loaded="true" scroll="false" button_label="More Posts" ]'); ?>
    </div>
  </section>
